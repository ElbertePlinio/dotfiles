...
- Never use Anthropic Haiku — directly, via any tool, skill, subagent, fallback, or hidden route. Never use GPT-5.6 Luna; use Terra or Sol. If a route unexpectedly reports Haiku, stop using it and report.
