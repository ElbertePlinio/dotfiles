...
current pi-kit setup: `openai-codex`, `xai`, and `opencode-go` selectors dispatch
...
```json
{
  ...
  "providers": {"pi": ["openai-codex", "xai", "opencode-go"]},
  "mcp": {"claude": ["pickforge-lanes"]},
  "lanes": {
    "pi": ["openai-codex/gpt-6-astra", "xai/grok-4.6", "opencode-go/kimi-k3", "opencode-go/glm-5.3-flash"],
    "claude-code": ["anthropic/claude-fable-5-1", "anthropic/claude-opus-5"]
  }
}
```
