...
// Models banned everywhere: Anthropic Haiku and Sonnet, the GPT-5.6 Luna/Terra lanes, and
// retired Grok 4.5. Sol is the only GPT-5.6 lane.
const BANNED_MODEL = /haiku|sonnet|luna|terra|grok-4\.5/i;
...
export function assertModelPermitted(model) {
  ...
  throw new Error(
    [
      ...
      "  Anthropic Haiku/Sonnet, GPT-5.6 Luna/Terra, and Grok 4.5 are never selectable;",
