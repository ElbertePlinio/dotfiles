...
name: upgrade-stripe
description: >-
  Use when upgrading a Stripe API version or bumping a Stripe server-side SDK,
  when a Stripe call fails after a version bump, or when migrating off a
  deprecated Stripe API surface. Covers pinned-version strategy, changelog
  review, and per-language SDK upgrade steps.
metadata:
  short-description: Upgrade Stripe API versions and SDKs
  origin: https://docs.stripe.com (npx skills add, sourceType well-known)
  vendored: 2026-07-31
  license: Stripe documentation content; see https://stripe.com/legal
